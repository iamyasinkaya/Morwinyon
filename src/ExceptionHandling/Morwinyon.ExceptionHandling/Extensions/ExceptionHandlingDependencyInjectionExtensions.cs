...
public static class ExceptionHandlingDependencyInjectionExtensions
{
    ...
    public static Task ConfigureMorwinyonExceptionHandling(this IApplicationBuilder app)
    {
        return app.ConfigureMorwinyonExceptionHandling(options =>
        {
            options.UseLogger();
        });
    }
        ...
        Action<ExceptionHandlingOptions> optionsAction)
    {
        ...
        return ConfigureMorwinyonExceptionHandling(app, opt);
    }
    ...
    /// <returns>The IApplicationBuilder</returns>
    public static async Task ConfigureMorwinyonExceptionHandling(this IApplicationBuilder app,
