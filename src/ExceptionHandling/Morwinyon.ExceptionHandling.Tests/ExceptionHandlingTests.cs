...
using Moq;
using Morwinyon.AspNetCore.ExceptionHandling;
using Morwinyon.ExceptionHandling.Tests.Infrastructure.Extensions;
using Morwinyon.TestCommon.Tests.Common.Constants;
using NUnit.Framework;
using System.Text.Json;


namespace Morwinyon.ExceptionHandling.Tests;
    ...
    private static TestServer GetServerWithOptions(ExceptionHandlingOptions options)
    {
        var hostBuilder = new WebHostBuilder()
            ...
            .Configure(async (app) =>
            {
                ...
                await app.ConfigureMorwinyonExceptionHandling(options);
