...
namespace Morwinyon.AspNetCore.ApiVersioning;
...
public static class ApiVersioningDependencyInjectionExtension
{
    ...
    public static IServiceCollection AddMorwinyonApiVersioning(this IServiceCollection services)
    {
        return services.AddMorwinyonApiVersioning(options =>
        {
    ...
    public static IServiceCollection AddMorwinyonApiVersioning(this IServiceCollection services, Action<ApiVersioningConfig> options)
    {
