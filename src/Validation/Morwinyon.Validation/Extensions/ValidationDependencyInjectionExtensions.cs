...
using Morwinyon.Validation.Infrastructure.ActionFilters;
using Morwinyon.Validation.Infrastructure.Models.ConfigModels;
...
namespace Morwinyon.Validation.Extensions;
...
public static class ValidationDependencyInjectionExtensions
{
    ...
    public static IServiceCollection AddMorwinyonValidatorFromAssembly(this IServiceCollection services,
        Assembly assembly)
    {
    ...
    /// <param name="services">The ServiceCollection</param>
    /// <returns>retuns ServiceCollection</returns>
    public static IServiceCollection AddMorwinyonValidator(this IServiceCollection services)
    {
    ...
    /// <param name="services">The ServiceCollection</param>
    /// <returns>retuns ServiceCollection</returns>
    public static IServiceCollection AddMorwinyonValidatorFromAssemblyContaining<T>(this IServiceCollection services)
        where T : IValidator
    {
        ConfigureModelProvider(services);
